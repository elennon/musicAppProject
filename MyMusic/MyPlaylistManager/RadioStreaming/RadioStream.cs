...
namespace MyPlaylistManager.ShoutCast
{
    ...
    public sealed class RadioStream
    {
        ...
        public event EventHandler<object> NoSetUp;
        ...
        {
 //           url = "http://stream190b.grooveshark.com/stream.php?streamKey=e1ef9dc933885b1d3b88fd7a34ac2c160c1ebe5e_549b5caf_155a009_1161af9_16af82439_8_0";
        ...
        private async void FinishWebRequest(IAsyncResult result)
        {
            ...
            ri.agvBytes = (uint)mp3Frame.Bitrate / 8;           //_wfx.AvgBytesPerSec;
            ri.channels = (uint)(short)(mp3Frame.Channels);     //_wfx.Channels;
            ri.samplePerSec = (uint)mp3Frame.SamplingRate;      //_wfx.SamplesPerSec;
