...
namespace MyPlaylistManager.RadioStreaming
{
    //class GrooveSharkStreaming
    //{ 
    ...
    //    void Mplayer_MediaFailed(object sender, ExceptionRoutedEventArgs e)
    //    {
    //        string error = e.ErrorException.ToString();
    //        string error2 = e.ErrorException.Message;
    //    }
